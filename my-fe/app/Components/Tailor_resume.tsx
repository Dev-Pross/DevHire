    ...
    <div className="min-h-screen lg:h-screen lg:overflow-hidden flex flex-col md:flex-row p-6 md:p-10 gap-5">
      <div className="order-2 md:order-1 w-full md:w-1/2 lg:w-2/5 bg-white/10 h-auto md:h-[90dvh] flex items-end justify-center gap-2 rounded-xl p-4">
        <div className="w-full h-full flex flex-col xl:gap-16 justify-between p-3">
          <h1 className="text-white text-sm lg:text-md xl:text-lg px-6 py-4 uppercase text-center">
            Drop that dream job description here.
            <br /> Our AI will instantly highlight the keywords and skills you
          ...
          <div className="w-full inline-flex h-full justify-center items-end gap-2  md:m-0 lg:mb-2  px-3 py-1">
            <textarea
              ...
              className="bg-[#183b70] text-white w-full min-h-[4rem] max-h-[14rem] box-border block resize-none text-base text-sm md:text-md p-3 md:p-4 outline-none overflow-y-auto rounded-lg"
            ...
            <button
              ...
              } bg-blue-600 hover:bg-blue-800 transition w-12 h-12 md:w-16 md:h-16 text-black font-bold py-2 px-3 md:px-4 rounded-full md:rounded-4xl flex items-center justify-center focus:outline-none focus:shadow-outline`}
              type="button"
            >
              {loading ? (
      ...
      <div className="order-1 md:order-2 w-full md:w-1/2 lg:w-3/5 h-auto md:h-full flex flex-col gap-6">
        {loading ? (
          ...
          tailoredUrl && (
            <div
              className="w-full h-full md:h-[90%] border rounded-md flex flex-col gap-3"
              onContextMenu={(e) => {
                e.preventDefault();
                e.stopPropagation();
                return false;
        ...
        {!tailoredUrl && !loading && (
          <>
            ...
            <div className="w-full h-full md:h-[70vh] overflow-hidden">
              <div
                className="flex gap-6 w-full h-full px-4 overflow-x-auto scrollbar-hide"
