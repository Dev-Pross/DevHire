      ...
      <div className={''}>
        ...
        >
            <motion.div
                ...
                >
            <div className=' flex px-32 mx-10 py-10 gap-10 justify-between shadow-black-500 shadow-lg'>
           ...
           <motion.div
            ...
            whileHover={{ scale: 1.01 }}
            >
            <div className=' flex px-32 p-10 gap-10 justify-between shadow-black shadow-lg'>
                <div className='flex-10  p-5 content-center'>
