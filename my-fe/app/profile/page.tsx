          ...
          <div className='grid gap-6'>
            ...
            <div className='group p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:bg-white/10 transition-all duration-300'>
              <div className='flex items-center justify-between'>
                <div>
                  <h3 className='text-sm font-medium text-white/60 uppercase tracking-wider mb-2'>Full Name</h3>
                  <p className='text-xl font-semibold text-white'>Srinivas Sai Saran Teja</p>
                </div>
            ...
            <div className='group p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:bg-white/10 transition-all duration-300'>
              <div className='flex items-center justify-between'>
                <div>
                  <h3 className='text-sm font-medium text-white/60 uppercase tracking-wider mb-2'>Email Address</h3>
                  <p className='text-xl font-semibold text-white'>teja@gmail.com</p>
                </div>
            ...
            <div className='group p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:bg-white/10 transition-all duration-300'>
              <div className='flex items-center justify-between'>
                <div>
                  <h3 className='text-sm font-medium text-white/60 uppercase tracking-wider mb-2'>Phone Number</h3>
                  <p className='text-xl font-semibold text-white'>+91 7410852096</p>
                </div>
